...
ConsumerProperties = namedtuple('ConsumerProperties', ['uuid', 'event_names', 'callback'])
...
class CoreBusConsumer(kombu.mixins.ConsumerMixin):
    ...
    def on_iteration(self):
        while self._new_consumers:
            uuid, event_names, callback = self._new_consumers.pop()
    ...
    def subscribe_to_event_names(self, uuid, event_names, callback):
        ...
        self._new_consumers.append(ConsumerProperties(uuid, event_names, callback))
