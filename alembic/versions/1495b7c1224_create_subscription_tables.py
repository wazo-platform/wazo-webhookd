...
def downgrade():
    op.drop_constraint('webhookd_subscription_event_subscription_uuid_fkey', 'webhookd_subscription_event', type_='foreignkey')
    op.drop_constraint('webhookd_subscription_option_subscription_uuid_fkey', 'webhookd_subscription_option', type_='foreignkey')
